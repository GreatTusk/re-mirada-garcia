export default function BajoConstruccion() {
  return (
    <div className="py-64 px-4 mx-auto max-w-screen-md text-center  lg:px-12">
      <svg
      ...
      <p className="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">
        El equipo de MiradaGarcía está trabajando duro para brindar un mejor
        servicio.
      </p>
    </div>
  );
