...
export default function ProductoEditForm({
  ...
  const [incluye, setIncluye] = useState<string[]>(producto.incluye || []);
  ...
  return (
    <form
      action={async (formData) => {
        const res = await updateProductoServicio(
          state,
          formData,
          incluye,
          noIncluye,
      ...
      <div className="rounded-md bg-gray-50 p-4 md:p-6">
        ...
        <div className="mb-4">
          ...
          <input
            ...
            name="imagen_url"
            type="text"
            defaultValue={producto.producto.imagen_url}
            placeholder="Enter image URL"
            className="block w-full rounded-md border border-gray-200 py-2 pl-3 text-sm outline-2 placeholder:text-gray-500"
            aria-describedby="imagen_url-error"
            onClick={() =>
              setState({
                ...state,
                errors: {
        ...
        <div className="mb-4">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={producto.producto.precio_oferta}
